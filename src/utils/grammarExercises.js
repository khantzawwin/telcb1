...
export const exercises = {
  ...
  // ─── Klasse K15 — Pronomen & Häufige Verwechslungen ───────────────────────

  personalpronomen_deklination_nach_f_llen_ich_mich_mir: [
    {
      id: 'pp_1',
      question: 'Kannst du _____ helfen? Ich verstehe die Aufgabe nicht.',
      options: ['mir', 'mich', 'ich'],
      answer: 'mir',
      explanation: '"helfen" takes the Dativ → mir. Dative pronouns end in -r/-m/-n (mir, dir, ihm, ihr, ihnen).',
    },
    {
      id: 'pp_2',
      question: 'Ich sehe _____ morgen auf der Party.',
      options: ['dich', 'dir', 'du'],
      answer: 'dich',
      explanation: '"sehen" takes the Akkusativ (direct object) → dich. The -ch forms (mich, dich) are Akkusativ.',
    },
    {
      id: 'pp_3',
      question: 'Das Buch gehört _____. Es ist seins.',
      options: ['ihm', 'ihn', 'er'],
      answer: 'ihm',
      explanation: '"gehören" takes the Dativ → ihm (to him). Not "ihn" (that would be Akkusativ).',
    },
    {
      id: 'pp_4',
      question: 'Er fragt _____, ob ich Zeit habe.',
      options: ['mich', 'mir', 'ich'],
      answer: 'mich',
      explanation: '"fragen" takes the Akkusativ → mich. He asks me (direct object).',
    },
    {
      id: 'pp_5',
      question: 'Wir danken _____ herzlich für Ihre Hilfe.',
      options: ['Ihnen', 'Sie', 'Ihr'],
      answer: 'Ihnen',
      explanation: '"danken" takes the Dativ → Ihnen (formal "you", Dativ). Sie would be Nominativ/Akkusativ.',
    },
    {
      id: 'pp_6',
      question: 'Kannst du _____ bitte das Salz geben?',
      options: ['mir', 'mich', 'ich'],
      answer: 'mir',
      explanation: 'The person you give something TO is the Dativ (indirect object) → mir. "das Salz" is the Akkusativ object.',
    },
    {
      id: 'pp_7',
      question: 'Ich habe _____ gestern im Park gesehen. (die Frau)',
      options: ['sie', 'ihr', 'ihn'],
      answer: 'sie',
      explanation: 'Feminine Akkusativ pronoun = sie (unchanged from Nominativ). "ihn" is masculine, "ihr" is Dativ.',
    },
    {
      id: 'pp_8',
      question: 'Der Lehrer erklärt _____ die Grammatik. (uns)',
      options: ['uns', 'wir', 'unser'],
      answer: 'uns',
      explanation: '"erklären" — the person you explain TO is the Dativ → uns. "die Grammatik" is the Akkusativ object.',
    },
    {
      id: 'pp_9',
      question: 'Ich liebe _____! Du bist wunderbar.',
      options: ['dich', 'dir', 'du'],
      answer: 'dich',
      explanation: '"lieben" takes the Akkusativ → dich. The -ch ending signals Akkusativ.',
    },
    {
      id: 'pp_10',
      question: 'Gehört das Auto _____? (ihr = you all)',
      options: ['euch', 'ihr', 'euer'],
      answer: 'euch',
      explanation: '"gehören" takes the Dativ → euch (Dativ of "ihr"). "euer" is a possessive, not a pronoun object.',
    },
  ],

  possessivartikel_possessivpronomen_mein_dein_sein: [
    {
      id: 'poss_1',
      question: 'Das ist _____ Bruder. (my — masculine, Nominativ)',
      options: ['mein', 'meine', 'meinen'],
      answer: 'mein',
      explanation: 'Masculine Nominativ takes no ending → mein Bruder (like "ein Bruder").',
    },
    {
      id: 'poss_2',
      question: 'Ich helfe _____ Bruder. (my — masculine, Dativ)',
      options: ['meinem', 'meinen', 'mein'],
      answer: 'meinem',
      explanation: '"helfen" + Dativ. Masculine Dativ ending = -em → meinem Bruder.',
    },
    {
      id: 'poss_3',
      question: 'Er liebt _____ Schwester. (his — feminine, Akkusativ)',
      options: ['seine', 'sein', 'seiner'],
      answer: 'seine',
      explanation: 'Owner = er → stem "sein". Feminine Akkusativ ending = -e → seine Schwester.',
    },
    {
      id: 'poss_4',
      question: 'Wo sind _____ Schlüssel? (your — dein, plural, Nominativ)',
      options: ['deine', 'dein', 'deinen'],
      answer: 'deine',
      explanation: 'Plural Nominativ ending = -e → deine Schlüssel.',
    },
    {
      id: 'poss_5',
      question: 'Sie fährt mit _____ Auto. (her — neuter, Dativ)',
      options: ['ihrem', 'ihr', 'ihren'],
      answer: 'ihrem',
      explanation: '"mit" + Dativ. Owner = sie → stem "ihr". Neuter Dativ ending = -em → ihrem Auto.',
    },
    {
      id: 'poss_6',
      question: 'Wir besuchen _____ Großeltern. (our — plural, Akkusativ)',
      options: ['unsere', 'unseren', 'unser'],
      answer: 'unsere',
      explanation: 'Owner = wir → stem "unser". Plural Akkusativ ending = -e → unsere Großeltern.',
    },
    {
      id: 'poss_7',
      question: '_____ Kinder spielen im Garten. (your — euer, plural, Nominativ)',
      options: ['Eure', 'Euer', 'Euren'],
      answer: 'Eure',
      explanation: 'Owner = ihr → stem "euer". With an ending, euer drops the middle -e → eure Kinder.',
    },
    {
      id: 'poss_8',
      question: 'Kennst du _____ Namen? (his — masculine, Akkusativ)',
      options: ['seinen', 'sein', 'seinem'],
      answer: 'seinen',
      explanation: 'Masculine Akkusativ ending = -en → seinen Namen (der Name → den/seinen Namen).',
    },
    {
      id: 'poss_9',
      question: 'Das Haus _____ Eltern ist sehr groß. (my — plural, Genitiv)',
      options: ['meiner', 'meine', 'meinen'],
      answer: 'meiner',
      explanation: 'Genitiv plural ending = -er → das Haus meiner Eltern.',
    },
    {
      id: 'poss_10',
      question: 'Ist das _____ Tasche? (your — dein, feminine, Nominativ)',
      options: ['deine', 'dein', 'deinen'],
      answer: 'deine',
      explanation: 'Feminine Nominativ ending = -e → deine Tasche.',
    },
  ],

  wurde_w_rde_wird_worden_geworden_die_formen_von_werden: [
    {
      id: 'ww_1',
      question: 'Ich _____ dir gern helfen, aber ich habe leider keine Zeit.',
      options: ['würde', 'wurde', 'wird'],
      answer: 'würde',
      explanation: '"würde" = Konjunktiv II (would). It is hypothetical — the help does not actually happen.',
    },
    {
      id: 'ww_2',
      question: 'Das Haus _____ 1990 gebaut. (Passiv, echte Vergangenheit)',
      options: ['wurde', 'würde', 'wird'],
      answer: 'wurde',
      explanation: '"wurde" = Passiv Präteritum — a real past event. wurde + Partizip II (gebaut).',
    },
    {
      id: 'ww_3',
      question: 'Nach dem Studium ist er Arzt _____.',
      options: ['geworden', 'worden', 'wurde'],
      answer: 'geworden',
      explanation: '"werden" as a full verb (to become) → Partizip = geworden. "Er ist Arzt geworden."',
    },
    {
      id: 'ww_4',
      question: 'Der Brief ist gestern geschrieben _____. (Passiv Perfekt)',
      options: ['worden', 'geworden', 'wurde'],
      answer: 'worden',
      explanation: 'In the passive Perfekt, "werden" becomes "worden" (never "geworden"): ist geschrieben worden.',
    },
    {
      id: 'ww_5',
      question: 'Nächstes Jahr _____ meine Schwester 18.',
      options: ['wird', 'wurde', 'würde'],
      answer: 'wird',
      explanation: '"wird" = Präsens of werden (here: to become / future). A real, upcoming fact.',
    },
    {
      id: 'ww_6',
      question: '_____ Sie bitte einen Moment warten?',
      options: ['Würden', 'Wurden', 'Wird'],
      answer: 'Würden',
      explanation: '"Würden Sie …?" = Konjunktiv II for a polite request. The Umlaut marks the polite/hypothetical form.',
    },
    {
      id: 'ww_7',
      question: 'Früher _____ in dieser Fabrik Autos produziert. (Passiv, Vergangenheit)',
      options: ['wurden', 'würden', 'worden'],
      answer: 'wurden',
      explanation: '"wurden" = Passiv Präteritum plural (real past). Autos (plural) → wurden produziert.',
    },
    {
      id: 'ww_8',
      question: 'Wenn ich reich wäre, _____ ich um die Welt reisen.',
      options: ['würde', 'wurde', 'wird'],
      answer: 'würde',
      explanation: 'The "wenn … wäre" signals Konjunktiv II → würde (hypothetical). Not a real event.',
    },
    {
      id: 'ww_9',
      question: 'Das Problem ist noch nicht gelöst _____. (Passiv Perfekt)',
      options: ['worden', 'geworden', 'würde'],
      answer: 'worden',
      explanation: 'Passiv Perfekt with a Partizip in front → worden: "ist gelöst worden".',
    },
    {
      id: 'ww_10',
      question: 'Es ist plötzlich sehr kalt _____. (werden = to become)',
      options: ['geworden', 'worden', 'wurde'],
      answer: 'geworden',
      explanation: '"werden" as a full verb (become) with no other Partizip → geworden. "Es ist kalt geworden."',
    },
  ],

  war_w_re_hatte_h_tte_indikativ_oder_konjunktiv_ii: [
    {
      id: 'wh_1',
      question: 'Gestern _____ ich krank und blieb zu Hause.',
      options: ['war', 'wäre', 'würde'],
      answer: 'war',
      explanation: '"war" = Indikativ (real past). It actually happened.',
    },
    {
      id: 'wh_2',
      question: 'An deiner Stelle _____ ich vorsichtiger.',
      options: ['wäre', 'war', 'wurde'],
      answer: 'wäre',
      explanation: '"An deiner Stelle" signals a hypothesis → Konjunktiv II "wäre" (I would be).',
    },
    {
      id: 'wh_3',
      question: 'Ich _____ gestern leider keine Zeit für dich.',
      options: ['hatte', 'hätte', 'würde'],
      answer: 'hatte',
      explanation: '"hatte" = Indikativ (real past of haben). A fact that really happened.',
    },
    {
      id: 'wh_4',
      question: '_____ ich mehr Geld, würde ich ein Haus kaufen.',
      options: ['Hätte', 'Hatte', 'Habe'],
      answer: 'Hätte',
      explanation: 'The sentence is hypothetical (paired with "würde … kaufen") → Konjunktiv II "Hätte" (if I had).',
    },
    {
      id: 'wh_5',
      question: '_____ du mir bitte kurz helfen? (höfliche Bitte)',
      options: ['Könntest', 'Konntest', 'Kannst'],
      answer: 'Könntest',
      explanation: 'A polite request uses Konjunktiv II → könntest (with Umlaut). "Konntest" would be the real past "could".',
    },
    {
      id: 'wh_6',
      question: 'Früher _____ wir kein Auto, wir fuhren mit dem Bus.',
      options: ['hatten', 'hätten', 'würden'],
      answer: 'hatten',
      explanation: '"hatten" = Indikativ (real past). A statement about how things really were.',
    },
    {
      id: 'wh_7',
      question: 'Wenn ich du _____, würde ich sofort mit ihr sprechen.',
      options: ['wäre', 'war', 'würde'],
      answer: 'wäre',
      explanation: '"Wenn ich du wäre" = if I were you — Konjunktiv II. Hypothetical → wäre.',
    },
    {
      id: 'wh_8',
      question: 'Das _____ ich wirklich nicht gedacht! (I would not have thought that)',
      options: ['hätte', 'hatte', 'würde'],
      answer: 'hätte',
      explanation: '"hätte … gedacht" = Konjunktiv II der Vergangenheit (would not have thought). Hypothetical past → hätte.',
    },
  ],

  seit_vor_bis_bevor_w_hrend_zeitw_rter_richtig_verwenden: [
    {
      id: 'zw_1',
      question: 'Ich lerne _____ einem Jahr Deutsch. (und lerne immer noch)',
      options: ['seit', 'vor', 'bis'],
      answer: 'seit',
      explanation: '"seit" = an action that started in the past and is STILL going on. seit + Dativ (einem Jahr).',
    },
    {
      id: 'zw_2',
      question: '_____ drei Tagen war ich beim Arzt. (abgeschlossen)',
      options: ['Vor', 'Seit', 'Bis'],
      answer: 'Vor',
      explanation: '"vor" = a finished point in the past (three days AGO). vor + Dativ.',
    },
    {
      id: 'zw_3',
      question: '_____ ich einkaufe, schreibe ich immer eine Liste.',
      options: ['Bevor', 'Vor', 'Bis'],
      answer: 'Bevor',
      explanation: '"bevor" is a conjunction introducing a clause (before I do X). "vor" is a preposition + noun only.',
    },
    {
      id: 'zw_4',
      question: 'Wir bleiben hier und warten _____ Montag.',
      options: ['bis', 'seit', 'bevor'],
      answer: 'bis',
      explanation: '"bis" marks the END point (until Monday).',
    },
    {
      id: 'zw_5',
      question: '_____ des Essens sollte man nicht telefonieren.',
      options: ['Während', 'Bevor', 'Seit'],
      answer: 'Während',
      explanation: '"während" = during (at the same time). As a preposition it takes the Genitiv → während des Essens.',
    },
    {
      id: 'zw_6',
      question: '_____ wann seid ihr schon in Berlin?',
      options: ['Seit', 'Vor', 'Bis'],
      answer: 'Seit',
      explanation: '"Seit wann?" = since when (still ongoing). A duration that reaches into the present → seit.',
    },
    {
      id: 'zw_7',
      question: 'Meine Eltern haben _____ zwanzig Jahren geheiratet.',
      options: ['vor', 'seit', 'während'],
      answer: 'vor',
      explanation: '"vor" = ago. The wedding is a finished event twenty years in the past → vor zwanzig Jahren.',
    },
    {
      id: 'zw_8',
      question: '_____ er kocht, deckt sie schon den Tisch.',
      options: ['Während', 'Bevor', 'Bis'],
      answer: 'Während',
      explanation: '"während" as a conjunction = while (two things at the same time). Verb goes to the end: während er kocht.',
    },
  ],

  das_oder_dass_seit_oder_seid_h_ufig_verwechselte_w_rter: [
    {
      id: 'vw_1',
      question: 'Ich hoffe, _____ du bald wieder gesund bist.',
      options: ['dass', 'das'],
      answer: 'dass',
      explanation: '"dass" = conjunction (that). You cannot replace it with dieses/welches → dass.',
    },
    {
      id: 'vw_2',
      question: 'Das Buch, _____ ich gerade lese, ist spannend.',
      options: ['das', 'dass'],
      answer: 'das',
      explanation: 'Relative pronoun referring to "das Buch". You can replace it with "welches" → das (one s).',
    },
    {
      id: 'vw_3',
      question: '_____ ihr schon fertig mit den Hausaufgaben?',
      options: ['Seid', 'Seit'],
      answer: 'Seid',
      explanation: '"seid" = ihr-form of sein (you are). The subject is "ihr" → seid (with d).',
    },
    {
      id: 'vw_4',
      question: 'Ich wohne _____ 2019 in Hamburg.',
      options: ['seit', 'seid'],
      answer: 'seit',
      explanation: '"seit" (with t) = time word (since). Nothing to do with the verb sein.',
    },
    {
      id: 'vw_5',
      question: 'Es ist so kalt, _____ ich friere.',
      options: ['dass', 'das'],
      answer: 'dass',
      explanation: '"so … dass" (so … that) is a fixed result construction → dass (two s).',
    },
    {
      id: 'vw_6',
      question: '_____ Kind spielt fröhlich im Garten.',
      options: ['Das', 'Dass'],
      answer: 'Das',
      explanation: 'Here it is the article "das" (das Kind = the child). Replaceable by "dieses" → das.',
    },
    {
      id: 'vw_7',
      question: '_____ kommst du heute nach Hause?',
      options: ['Wann', 'Wenn', 'Wen'],
      answer: 'Wann',
      explanation: '"wann" asks a question about time (when?). "wenn" = if/whenever, "wen" = whom.',
    },
    {
      id: 'vw_8',
      question: '_____ hast du zu der Feier eingeladen?',
      options: ['Wen', 'Wenn', 'Wann'],
      answer: 'Wen',
      explanation: '"wen" = whom (Akkusativ of wer). It asks about the direct object of "einladen".',
    },
    {
      id: 'vw_9',
      question: '_____ du Zeit hast, ruf mich bitte an.',
      options: ['Wenn', 'Wann', 'Wen'],
      answer: 'Wenn',
      explanation: '"wenn" = if / whenever (a condition), not a question. → Wenn du Zeit hast.',
    },
  ],
